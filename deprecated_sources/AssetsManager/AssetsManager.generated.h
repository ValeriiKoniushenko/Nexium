...
struct R<Core::AssetsManager::NodeType>
{
    ...
    static constexpr std::string_view FullName() { return "Core::AssetsManager::NodeType"; }
    ...
    static void Serialize(::Core::AssetsManager::NodeType value, RResourceStream<RImpl>& s)
    {
        s.getData() = ToString(value);
    }

    template<IsResourceStreamImpl RImpl = RJsonResourceStream>
    static RResourceStream<RImpl> Serialize(::Core::AssetsManager::NodeType value)
    {
    ...
    template<IsResourceStreamImpl RImpl = RJsonResourceStream>
    static void Deserialize(const RResourceStream<RImpl>& s, ::Core::AssetsManager::NodeType& value)
    {
    ...
    template<IsResourceStreamImpl RImpl = RJsonResourceStream>
    [[nodiscard]] static ::Core::AssetsManager::NodeType Deserialize(const RResourceStream<RImpl>& s)
    {
        ::Core::AssetsManager::NodeType out;
