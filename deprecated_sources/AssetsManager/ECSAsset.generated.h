...
struct R<Core::ECSAsset::Status>
{
    ...
    static constexpr std::string_view FullName() { return "Core::ECSAsset::Status"; }
    ...
    static void Serialize(::Core::ECSAsset::Status value, RResourceStream<RImpl>& s)
    {
        s.getData() = ToString(value);
    }

    template<IsResourceStreamImpl RImpl = RJsonResourceStream>
    static RResourceStream<RImpl> Serialize(::Core::ECSAsset::Status value)
    {
    ...
    template<IsResourceStreamImpl RImpl = RJsonResourceStream>
    static void Deserialize(const RResourceStream<RImpl>& s, ::Core::ECSAsset::Status& value)
    {
    ...
    template<IsResourceStreamImpl RImpl = RJsonResourceStream>
    [[nodiscard]] static ::Core::ECSAsset::Status Deserialize(const RResourceStream<RImpl>& s)
    {
        ::Core::ECSAsset::Status out;
