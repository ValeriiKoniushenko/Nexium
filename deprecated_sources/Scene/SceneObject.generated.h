...
struct R<Core::SceneObject>
{
    ...
    static constexpr std::string_view FullName() { return "Core::SceneObject"; }
    ...
    static void Serialize(const Core::SceneObject& obj, RResourceStream<RImpl>& s, bool noSignals = false)
    {
		...
		s.write(R<Core::IOutliner>::Serialize<RImpl>(obj).getData());
    ...
    static void Deserialize(const RResourceStream<RImpl>& s, Core::SceneObject& obj, bool noSignals = false)
    {
		...
		R<Core::IOutliner>::Deserialize<RImpl>(s, obj, true);
    ...
    static bool GetField(Core::SceneObject& obj, const char* fieldName, const std::function<void(void*, const char*)>& onFound)
    {
