...
struct R<Core::GameViewportEWC>
{
    ...
    static constexpr std::string_view FullName() { return "Core::GameViewportEWC"; }
    ...
    static bool GetField(Core::GameViewportEWC& obj, const char* fieldName, const std::function<void(void*, const char*)>& onFound)
    {
