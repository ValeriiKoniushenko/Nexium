...
struct R<Core::SceneTreeWindowEWC>
{
    ...
    static constexpr std::string_view FullName() { return "Core::SceneTreeWindowEWC"; }
    ...
    static bool GetField(Core::SceneTreeWindowEWC& obj, const char* fieldName, const std::function<void(void*, const char*)>& onFound)
    {
