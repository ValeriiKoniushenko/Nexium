...
struct R<Core::NxEditorBaseEditorEWC>
{
    ...
    static constexpr std::string_view FullName() { return "Core::NxEditorBaseEditorEWC"; }
    ...
    static bool GetField(Core::NxEditorBaseEditorEWC& obj, const char* fieldName, const std::function<void(void*, const char*)>& onFound)
    {
