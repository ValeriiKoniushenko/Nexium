...
struct R<Core::AssetsManagerWindowEWC>
{
    ...
    static constexpr std::string_view FullName() { return "Core::AssetsManagerWindowEWC"; }
    ...
    static bool GetField(Core::AssetsManagerWindowEWC& obj, const char* fieldName, const std::function<void(void*, const char*)>& onFound)
    {
