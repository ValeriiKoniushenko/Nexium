...
struct R<Core::Gui::BaseCombo>
{
    ...
    static constexpr std::string_view FullName() { return "Core::Gui::BaseCombo"; }
    ...
    static void Deserialize(const RResourceStream<RImpl>& s, Core::Gui::BaseCombo& obj, bool noSignals = false)
    {
		...
		s.read("_size", obj._size, glm::vec2(50.f, 0.f), 16);
        if (!noSignals)
        {
    ...
    static bool GetField(Core::Gui::BaseCombo& obj, const char* fieldName, const std::function<void(void*, const char*)>& onFound)
    {
...
struct R<Core::Gui::ComboView>
{
    ...
    static constexpr std::string_view FullName() { return "Core::Gui::ComboView"; }
    static constexpr std::string_view ParentScope() { return "Core::Gui"; }
    ...
    static bool GetField(Core::Gui::ComboView& obj, const char* fieldName, const std::function<void(void*, const char*)>& onFound)
    {
        if (!onFound) return false;
...
struct R<Core::Gui::ComboModelBased>
{
    ...
    static constexpr std::string_view FullName() { return "Core::Gui::ComboModelBased"; }
    static constexpr std::string_view ParentScope() { return "Core::Gui"; }
    static constexpr std::size_t GetFieldNumbers() { return 0; }
    static constexpr std::vector<RClassField> GetFields() {
        return {
    ...
    static bool GetField(Core::Gui::ComboModelBased& obj, const char* fieldName, const std::function<void(void*, const char*)>& onFound)
    {
        if (!onFound) return false;
