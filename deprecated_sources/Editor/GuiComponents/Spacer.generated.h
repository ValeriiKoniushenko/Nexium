...
struct R<Core::Gui::Spacer>
{
    ...
    static constexpr std::string_view FullName() { return "Core::Gui::Spacer"; }
    ...
    static bool GetField(Core::Gui::Spacer& obj, const char* fieldName, const std::function<void(void*, const char*)>& onFound)
    {
