...
struct R<Core::Gui::ArrayCell>
{
    ...
    static constexpr std::string_view FullName() { return "Core::Gui::ArrayCell"; }
    ...
    static bool GetField(Core::Gui::ArrayCell& obj, const char* fieldName, const std::function<void(void*, const char*)>& onFound)
    {
