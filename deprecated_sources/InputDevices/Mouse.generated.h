...
struct R<Core::Mouse::State>
{
    ...
    static constexpr std::string_view FullName() { return "Core::Mouse::State"; }
    ...
    static void Serialize(::Core::Mouse::State value, RResourceStream<RImpl>& s)
    {
        s.getData() = ToString(value);
    }

    template<IsResourceStreamImpl RImpl = RJsonResourceStream>
    static RResourceStream<RImpl> Serialize(::Core::Mouse::State value)
    {
    ...
    template<IsResourceStreamImpl RImpl = RJsonResourceStream>
    static void Deserialize(const RResourceStream<RImpl>& s, ::Core::Mouse::State& value)
    {
    ...
    template<IsResourceStreamImpl RImpl = RJsonResourceStream>
    [[nodiscard]] static ::Core::Mouse::State Deserialize(const RResourceStream<RImpl>& s)
    {
        ::Core::Mouse::State out;
...
struct R<Core::Mouse::Key>
{
    ...
    static constexpr std::string_view FullName() { return "Core::Mouse::Key"; }
    ...
    template<IsResourceStreamImpl RImpl = RJsonResourceStream>
    static void Serialize(::Core::Mouse::Key value, RResourceStream<RImpl>& s)
    {
        s.getData() = ToString(value);
    }

    template<IsResourceStreamImpl RImpl = RJsonResourceStream>
    static RResourceStream<RImpl> Serialize(::Core::Mouse::Key value)
    {
        RResourceStream<RImpl> s;
        Serialize<RImpl>(value, s);
        return s;
    ...
    template<IsResourceStreamImpl RImpl = RJsonResourceStream>
    static void Deserialize(const RResourceStream<RImpl>& s, ::Core::Mouse::Key& value)
    {
        auto tmp = FromString(s.getData().template get<std::string>());
        if (tmp.has_value())
            value = tmp.value();
    ...
    template<IsResourceStreamImpl RImpl = RJsonResourceStream>
    [[nodiscard]] static ::Core::Mouse::Key Deserialize(const RResourceStream<RImpl>& s)
    {
        ::Core::Mouse::Key out;
        Deserialize<RImpl>(s, out);
        return out;
...
struct R<Core::Mouse::Mod>
{
    ...
    static constexpr std::string_view FullName() { return "Core::Mouse::Mod"; }
    ...
    template<IsResourceStreamImpl RImpl = RJsonResourceStream>
    static void Serialize(::Core::Mouse::Mod value, RResourceStream<RImpl>& s)
    {
        s.getData() = ToString(value);
    }

    template<IsResourceStreamImpl RImpl = RJsonResourceStream>
    static RResourceStream<RImpl> Serialize(::Core::Mouse::Mod value)
    {
        RResourceStream<RImpl> s;
        Serialize<RImpl>(value, s);
        return s;
    ...
    template<IsResourceStreamImpl RImpl = RJsonResourceStream>
    static void Deserialize(const RResourceStream<RImpl>& s, ::Core::Mouse::Mod& value)
    {
        auto tmp = FromString(s.getData().template get<std::string>());
        if (tmp.has_value())
            value = tmp.value();
    ...
    template<IsResourceStreamImpl RImpl = RJsonResourceStream>
    [[nodiscard]] static ::Core::Mouse::Mod Deserialize(const RResourceStream<RImpl>& s)
    {
        ::Core::Mouse::Mod out;
        Deserialize<RImpl>(s, out);
        return out;
