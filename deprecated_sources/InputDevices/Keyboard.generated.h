...
struct R<Core::Keyboard::KeyState>
{
    ...
    static constexpr std::string_view FullName() { return "Core::Keyboard::KeyState"; }
    ...
    static void Serialize(::Core::Keyboard::KeyState value, RResourceStream<RImpl>& s)
    {
        s.getData() = ToString(value);
    }

    template<IsResourceStreamImpl RImpl = RJsonResourceStream>
    static RResourceStream<RImpl> Serialize(::Core::Keyboard::KeyState value)
    {
    ...
    template<IsResourceStreamImpl RImpl = RJsonResourceStream>
    static void Deserialize(const RResourceStream<RImpl>& s, ::Core::Keyboard::KeyState& value)
    {
    ...
    template<IsResourceStreamImpl RImpl = RJsonResourceStream>
    [[nodiscard]] static ::Core::Keyboard::KeyState Deserialize(const RResourceStream<RImpl>& s)
    {
        ::Core::Keyboard::KeyState out;
...
struct R<Core::Keyboard::Key>
{
    ...
    static constexpr std::string_view FullName() { return "Core::Keyboard::Key"; }
    ...
    template<IsResourceStreamImpl RImpl = RJsonResourceStream>
    static void Serialize(::Core::Keyboard::Key value, RResourceStream<RImpl>& s)
    {
        s.getData() = ToString(value);
    }

    template<IsResourceStreamImpl RImpl = RJsonResourceStream>
    static RResourceStream<RImpl> Serialize(::Core::Keyboard::Key value)
    {
        RResourceStream<RImpl> s;
        Serialize<RImpl>(value, s);
        return s;
    ...
    template<IsResourceStreamImpl RImpl = RJsonResourceStream>
    static void Deserialize(const RResourceStream<RImpl>& s, ::Core::Keyboard::Key& value)
    {
        auto tmp = FromString(s.getData().template get<std::string>());
        if (tmp.has_value())
            value = tmp.value();
    ...
    template<IsResourceStreamImpl RImpl = RJsonResourceStream>
    [[nodiscard]] static ::Core::Keyboard::Key Deserialize(const RResourceStream<RImpl>& s)
    {
        ::Core::Keyboard::Key out;
        Deserialize<RImpl>(s, out);
        return out;
    }
