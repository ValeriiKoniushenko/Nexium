...
struct R<Core::DataStream::Result>
{
    ...
    static constexpr std::string_view FullName() { return "Core::DataStream::Result"; }
    ...
    static void Serialize(::Core::DataStream::Result value, RResourceStream<RImpl>& s)
    {
        s.getData() = ToString(value);
    }

    template<IsResourceStreamImpl RImpl = RJsonResourceStream>
    static RResourceStream<RImpl> Serialize(::Core::DataStream::Result value)
    {
    ...
    template<IsResourceStreamImpl RImpl = RJsonResourceStream>
    static void Deserialize(const RResourceStream<RImpl>& s, ::Core::DataStream::Result& value)
    {
    ...
    template<IsResourceStreamImpl RImpl = RJsonResourceStream>
    [[nodiscard]] static ::Core::DataStream::Result Deserialize(const RResourceStream<RImpl>& s)
    {
        ::Core::DataStream::Result out;
...
struct R<Core::DataStream::Mode>
{
    ...
    static constexpr std::string_view FullName() { return "Core::DataStream::Mode"; }
    ...
    template<IsResourceStreamImpl RImpl = RJsonResourceStream>
    static void Serialize(::Core::DataStream::Mode value, RResourceStream<RImpl>& s)
    {
        s.getData() = ToString(value);
    }

    template<IsResourceStreamImpl RImpl = RJsonResourceStream>
    static RResourceStream<RImpl> Serialize(::Core::DataStream::Mode value)
    {
        RResourceStream<RImpl> s;
        Serialize<RImpl>(value, s);
        return s;
    ...
    template<IsResourceStreamImpl RImpl = RJsonResourceStream>
    static void Deserialize(const RResourceStream<RImpl>& s, ::Core::DataStream::Mode& value)
    {
        auto tmp = FromString(s.getData().template get<std::string>());
        if (tmp.has_value())
            value = tmp.value();
    ...
    template<IsResourceStreamImpl RImpl = RJsonResourceStream>
    [[nodiscard]] static ::Core::DataStream::Mode Deserialize(const RResourceStream<RImpl>& s)
    {
        ::Core::DataStream::Mode out;
        Deserialize<RImpl>(s, out);
        return out;
    }
