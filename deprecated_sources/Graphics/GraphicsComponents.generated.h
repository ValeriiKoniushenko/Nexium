...
struct R<Core::BaseGraphicsData::ModifiedValue>
{
    ...
    static constexpr std::string_view FullName() { return "Core::BaseGraphicsData::ModifiedValue"; }
    ...
    static void Serialize(::Core::BaseGraphicsData::ModifiedValue value, RResourceStream<RImpl>& s)
    {
        s.getData() = ToString(value);
    }

    template<IsResourceStreamImpl RImpl = RJsonResourceStream>
    static RResourceStream<RImpl> Serialize(::Core::BaseGraphicsData::ModifiedValue value)
    {
    ...
    template<IsResourceStreamImpl RImpl = RJsonResourceStream>
    static void Deserialize(const RResourceStream<RImpl>& s, ::Core::BaseGraphicsData::ModifiedValue& value)
    {
    ...
    template<IsResourceStreamImpl RImpl = RJsonResourceStream>
    [[nodiscard]] static ::Core::BaseGraphicsData::ModifiedValue Deserialize(const RResourceStream<RImpl>& s)
    {
        ::Core::BaseGraphicsData::ModifiedValue out;
...
struct R<Core::BaseGraphicsData::Modifier>
{
    ...
    static constexpr std::string_view FullName() { return "Core::BaseGraphicsData::Modifier"; }
    ...
    template<IsResourceStreamImpl RImpl = RJsonResourceStream>
    static void Serialize(::Core::BaseGraphicsData::Modifier value, RResourceStream<RImpl>& s)
    {
        s.getData() = ToString(value);
    }

    template<IsResourceStreamImpl RImpl = RJsonResourceStream>
    static RResourceStream<RImpl> Serialize(::Core::BaseGraphicsData::Modifier value)
    {
        RResourceStream<RImpl> s;
        Serialize<RImpl>(value, s);
        return s;
    ...
    template<IsResourceStreamImpl RImpl = RJsonResourceStream>
    static void Deserialize(const RResourceStream<RImpl>& s, ::Core::BaseGraphicsData::Modifier& value)
    {
        auto tmp = FromString(s.getData().template get<std::string>());
        if (tmp.has_value())
            value = tmp.value();
    ...
    template<IsResourceStreamImpl RImpl = RJsonResourceStream>
    [[nodiscard]] static ::Core::BaseGraphicsData::Modifier Deserialize(const RResourceStream<RImpl>& s)
    {
        ::Core::BaseGraphicsData::Modifier out;
        Deserialize<RImpl>(s, out);
        return out;
    }
...
struct R<Core::BaseGraphicsData>
{
    ...
    static constexpr std::string_view FullName() { return "Core::BaseGraphicsData"; }
    ...
    static void Deserialize(const RResourceStream<RImpl>& s, Core::BaseGraphicsData& obj, bool noSignals = false)
    {
		...
		s.read("_drawModifiers", obj._drawModifiers, decltype(obj._drawModifiers){}, 16);
        if (!noSignals)
        {
    ...
    static bool GetField(Core::BaseGraphicsData& obj, const char* fieldName, const std::function<void(void*, const char*)>& onFound)
    {
        if (!onFound) return false;
        if (std::strcmp(fieldName, "_drawModifiers") == 0)
        {
            onFound((&obj._drawModifiers), "std::vector<ModifierParam>");
            return true;
        }
...
struct R<Core::BaseTextureGraphicsData>
{
    ...
    static constexpr std::string_view FullName() { return "Core::BaseTextureGraphicsData"; }
    static constexpr std::string_view ParentScope() { return "Core"; }
    ...
    static bool GetField(Core::BaseTextureGraphicsData& obj, const char* fieldName, const std::function<void(void*, const char*)>& onFound)
    {
        if (!onFound) return false;
...
struct R<Core::InterleavedGraphicsData>
{
    ...
    static constexpr std::string_view FullName() { return "Core::InterleavedGraphicsData"; }
    static constexpr std::string_view ParentScope() { return "Core"; }
    static constexpr std::size_t GetFieldNumbers() { return 0; }
    static constexpr std::vector<RClassField> GetFields() {
        return {
    ...
    static bool GetField(Core::InterleavedGraphicsData& obj, const char* fieldName, const std::function<void(void*, const char*)>& onFound)
    {
        if (!onFound) return false;
...
struct R<Core::SeparTextureGraphicsData>
{
    ...
    static constexpr std::string_view FullName() { return "Core::SeparTextureGraphicsData"; }
    static constexpr std::string_view ParentScope() { return "Core"; }
    static constexpr std::size_t GetFieldNumbers() { return 0; }
    static constexpr std::vector<RClassField> GetFields() {
        return {
    ...
    static bool GetField(Core::SeparTextureGraphicsData& obj, const char* fieldName, const std::function<void(void*, const char*)>& onFound)
    {
        if (!onFound) return false;
