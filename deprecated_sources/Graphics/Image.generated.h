...
struct R<Core::Image::Channel>
{
    ...
    static constexpr std::string_view FullName() { return "Core::Image::Channel"; }
    ...
    static void Serialize(::Core::Image::Channel value, RResourceStream<RImpl>& s)
    {
        s.getData() = ToString(value);
    }

    template<IsResourceStreamImpl RImpl = RJsonResourceStream>
    static RResourceStream<RImpl> Serialize(::Core::Image::Channel value)
    {
    ...
    template<IsResourceStreamImpl RImpl = RJsonResourceStream>
    static void Deserialize(const RResourceStream<RImpl>& s, ::Core::Image::Channel& value)
    {
    ...
    template<IsResourceStreamImpl RImpl = RJsonResourceStream>
    [[nodiscard]] static ::Core::Image::Channel Deserialize(const RResourceStream<RImpl>& s)
    {
        ::Core::Image::Channel out;
