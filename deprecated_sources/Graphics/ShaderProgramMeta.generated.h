...
struct R<Core::ShaderType>
{
    ...
    static constexpr std::string_view FullName() { return "Core::ShaderType"; }
    ...
    static void Serialize(::Core::ShaderType value, RResourceStream<RImpl>& s)
    {
        s.getData() = ToString(value);
    }

    template<IsResourceStreamImpl RImpl = RJsonResourceStream>
    static RResourceStream<RImpl> Serialize(::Core::ShaderType value)
    {
    ...
    template<IsResourceStreamImpl RImpl = RJsonResourceStream>
    static void Deserialize(const RResourceStream<RImpl>& s, ::Core::ShaderType& value)
    {
    ...
    template<IsResourceStreamImpl RImpl = RJsonResourceStream>
    [[nodiscard]] static ::Core::ShaderType Deserialize(const RResourceStream<RImpl>& s)
    {
        ::Core::ShaderType out;
