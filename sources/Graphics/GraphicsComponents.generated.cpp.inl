...
namespace Reflect
{
    ...
    namespace Core::GraphicsComponentData::Modifier
    {
        ...
        {
            static const std::string name = "Core::GraphicsComponentData";
            return name;
        }

        const std::string& ToString(::Core::GraphicsComponentData::Modifier value)
        {
            const auto& data = Reflect::Core::GraphicsComponentData::Modifier::ToMapCN();
        ...
        {
            const auto& data = Reflect::Core::GraphicsComponentData::Modifier::ToMapNC();
            const auto it = data.find(value);
            if (it != data.end()) [[likely]]
            {
                return it->second;
        ...
        const std::array<std::string, 3>& ToArrayN()
        {
            static constexpr std::array<std::string, 3> names
                = { std::string("None"), std::string("Enable"), std::string("Disable") };
        ...
        {
            static const std::unordered_map<::Core::GraphicsComponentData::Modifier, std::string>
        ...
        {
            static const std::unordered_map<std::string, ::Core::GraphicsComponentData::Modifier>
