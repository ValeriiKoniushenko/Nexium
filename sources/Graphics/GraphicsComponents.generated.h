...
struct R<Core::GraphicsComponentData::ModifiedValue>
{
    ...
    static std::optional<::Core::GraphicsComponentData::ModifiedValue> FromString(
    ...
    static const std::unordered_map<::Core::GraphicsComponentData::ModifiedValue, std::string_view>&
        ToMapCN()
    {
        static const std::unordered_map<::Core::GraphicsComponentData::ModifiedValue,
                                        std::string_view>
            map
    ...
    static const std::unordered_map<std::string_view, ::Core::GraphicsComponentData::ModifiedValue>&
        ToMapNC()
    {
        static const std::unordered_map<std::string_view,
                                        ::Core::GraphicsComponentData::ModifiedValue>
            map
...
struct R<Core::GraphicsComponentData::Modifier>
{
    ...
    static constexpr const std::array<std::string_view, 3>& ToArrayN()
    {
        static constexpr std::array<std::string_view, 3> names
            = { std::string_view("None"), std::string_view("Enable"), std::string_view("Disable") };

        return names;
    }

    static const std::unordered_map<::Core::GraphicsComponentData::Modifier, std::string_view>&
        ToMapCN()
    {
        static const std::unordered_map<::Core::GraphicsComponentData::Modifier, std::string_view>
            map = { { ::Core::GraphicsComponentData::Modifier::None, "None" },
    ...
    static const std::unordered_map<std::string_view, ::Core::GraphicsComponentData::Modifier>&
        ToMapNC()
    {
        static const std::unordered_map<std::string_view, ::Core::GraphicsComponentData::Modifier>
            map = { { "None", ::Core::GraphicsComponentData::Modifier::None },
