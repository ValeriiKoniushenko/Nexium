...
struct R<Core::AssetsManager::NodeType>
{
    ...
    static constexpr const std::array<::Core::AssetsManager::NodeType, 5>& ToArrayC()
    {
        static constexpr std::array<::Core::AssetsManager::NodeType, 5> constants
            = { ::Core::AssetsManager::NodeType::Default, ::Core::AssetsManager::NodeType::Code,
                ::Core::AssetsManager::NodeType::Image, ::Core::AssetsManager::NodeType::Folder,
    ...
    static constexpr const std::array<std::string_view, 5>& ToArrayN()
    {
        static constexpr std::array<std::string_view, 5> names
            = { std::string_view("Default"), std::string_view("Code"), std::string_view("Image"),
                std::string_view("Folder"), std::string_view("NxFile") };
