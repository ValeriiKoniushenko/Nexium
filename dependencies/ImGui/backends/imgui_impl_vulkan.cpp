...
void ImGui_ImplVulkanH_CreateWindowSwapChain(VkPhysicalDevice physical_device, VkDevice device, ImGui_ImplVulkanH_Window* wd, const VkAllocationCallbacks* allocator, int w, int h, uint32_t min_image_count)
{
    ...
    // Create Swapchain
    {
        ...
        info.sType = VK_STRUCTURE_TYPE_CoreAPCHAIN_CREATE_INFO_KHR;
    ...
    // Create The Image Views
    {
        ...
        info.components.r = VK_COMPONENT_CoreIZZLE_R;
        info.components.g = VK_COMPONENT_CoreIZZLE_G;
        info.components.b = VK_COMPONENT_CoreIZZLE_B;
        info.components.a = VK_COMPONENT_CoreIZZLE_A;
